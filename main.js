...
//punho branca
  ...
  btncorvistaDvermelha.addEventListener('click', function(e){
    document.getElementById('vista3').style.fill = "#FAECBA";
    document.getElementById('VD').style.backgroundColor = "#FAECBA";
  });  
  //vistaD amarela
  const btncorvistaDamarela = document.getElementById('yellowbase6');
  btncorvistaDamarela.addEventListener('click', function(e){
    document.getElementById('vista3').style.fill = "#F6DCCA";
    document.getElementById('VD').style.backgroundColor = "#F6DCCA";
  });  
  //vistaD verde
  const btncorvistaDverde = document.getElementById('greenbase6');
  btncorvistaDverde.addEventListener('click', function(e){
    document.getElementById('vista3').style.fill = "#A0B8AA";
    document.getElementById('VD').style.backgroundColor = "#A0B8AA";
  });
  ...
  btncorbolsoFvermelha.addEventListener('click', function(e){
    document.getElementById('bolsofaixa').style.fill = "#FAECBA";
    document.getElementById('BSF').style.backgroundColor = "#FAECBA";
  });  
  //Bolso Faixa amarela
  const btncorbolsoFamarela = document.getElementById('yellowbase7');
  btncorbolsoFamarela.addEventListener('click', function(e){
    document.getElementById('bolsofaixa').style.fill = "#F6DCCA";
    document.getElementById('BSF').style.backgroundColor = "#F6DCCA";
  });  
  //Bolso Faixa verde
  const btncorbolsoFverde = document.getElementById('greenbase7');
  btncorbolsoFverde.addEventListener('click', function(e){
    document.getElementById('bolsofaixa').style.fill = "#A0B8AA";
    document.getElementById('BSF').style.backgroundColor = "#A0B8AA";
  });
  ...
  btncorbolsoBvermelha.addEventListener('click', function(e){
    document.getElementById('bolso12').style.fill = "#FAECBA";
    document.getElementById('BB').style.backgroundColor = "#FAECBA";
  });  
  //Bolso Faixa amarela
  const btncorbolsoBamarela = document.getElementById('yellowbase8');
  btncorbolsoBamarela.addEventListener('click', function(e){
    document.getElementById('bolso12').style.fill = "#F6DCCA";
    document.getElementById('BB').style.backgroundColor = "#F6DCCA";
  });  
  //Bolso Faixa verde
  const btncorbolsoBverde = document.getElementById('greenbase8');
  btncorbolsoBverde.addEventListener('click', function(e){
    document.getElementById('bolso12').style.fill = "#A0B8AA";
    document.getElementById('BB').style.backgroundColor = "#A0B8AA";
  });
